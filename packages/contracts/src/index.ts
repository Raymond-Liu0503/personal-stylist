...
export const SuggestionSchema = z.object({observation:text(500),action:text(500),reason:text(500)}).strict();
...
export const FeedbackSchema = z.object({savedReportId:z.string().uuid().optional(),helpful:z.boolean(),issues:z.array(z.enum(['invented_details','unhelpful','offensive','incorrect_score','other'])).max(5)}).strict();
